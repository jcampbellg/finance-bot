...
export default async function menuSend(params: ConversationProps) {
  ...
  await bot.sendMessage(chatId, `¡Hola ${firstName}!\n¿En qué puedo ayudarte?`, {
    ...
    reply_markup: {
      inline_keyboard: [
        [{ text: '🧾 Nuevo Gasto', callback_data: 'trans_expense_new' }, { text: '🤑 Nuevo Ingreso', callback_data: 'trans_deposit_new' }],
        [{ text: '💵 Nuevo Pago Fijo', callback_data: 'trans_payment_new' }],
