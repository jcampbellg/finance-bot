  ...
  await bot.sendMessage(chatId, `¡Hola ${firstName}!\n¿En qué puedo ayudarte?`, {
    ...
    reply_markup: {
      inline_keyboard: [
        ...
        [{ text: '🤑 Nuevo Ingreso', callback_data: 'income_transaction_create' }, { text: '💵 Nuevo Pago Fijo', callback_data: 'payment_transaction_create' }],
        ...
        [{ text: '🧾 Ultimos Movimientos', callback_data: 'recent' }, { text: '💵 Pagos Pendientes', callback_data: 'payments_pending' }],
